...
* 汇聚国内外多种智能对话平台，支持自然语言理解、推理与生成，满足不同场景需求。

* 适用人群：公司所有同事，用于日常工作中的智能对话和自动化任务。
...
* 功能使用：
  ...
  - Deepseek对话（https://chat.deepseek.com）：输入对话内容，点击发送。
    ...
    优点：响应速度快，擅长处理复杂查询和跨领域问题，适用于日常与工作中的多种场景。
  ...
  - Grok对话（https://grok.com 需翻墙）：输入对话内容，点击发送。
    ...
    优点：分析深入，适合复杂对话和多样化问题的解析。
    
    缺点：多模态支持较弱，效果一般。

  - ChatGPT（https://chatgpt.com 需翻墙）：输入对话内容，点击发送。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-12-03_11-12-55.png)

    优点：功能强大，支持多任务处理，涵盖自然语言理解、对话生成及代码编写。
  ...
  - Qwen（https://www.qianwen.com）：输入对话内容，点击发送：
    ...
    优点：集成Qwen生态模型，支持新模型快速体验，可用于生成研究报告、PPT等多种任务。

    缺点：在特定领域的精度较低。

### Gamma（https://gamma.app 需翻墙）

* 快速生成高质量PPT/文档，支持智能排版和内容编辑。

* 适用人群：适合公司所有同事，帮助我们高效创建既美观又内容丰富的PPT。

* 功能使用：
  
  - 新建AI：轻松启动AI助手，开始制作PPT。
    
    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-30_21-53-00.png)

  - 粘贴文本：将内容粘贴进去，自动生成初步框架。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-30_21-54-00.png)

  - 输入PPT内容并选择模式：输入具体内容，选择创建模式，进入提示编辑器进行优化。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-30_21-58-45.png)

  - 编辑生成配置并点击生成：根据需求调整生成配置，快速生成PPT。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-30_22-10-20.png)
    
  - PPT编辑与自由调整：灵活编辑PPT内容和布局，打造个性化展示。
...
### NotebookLM（https://notebooklm.google.com 需翻墙）

* 由 Google 开发的 AI 驱动研究与思考助手，能根据用户上传的个性化资料（如文档、PDF、网站链接、YouTube 视频、音频文件等）提供摘要、分析和洞见，帮助用户更高效地进行研究和创作。

* 适用人群：公司所有同事，适用于学术研究、商业分析及内容创作。

* 功能使用：

  - 做笔记：记录并整理研究思路。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_21-46-39.png)
    
  - 制作学习卡：快速生成学习卡片，便于知识复习。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_21-49-55.png)

  - 生成测试题：根据内容自动生成测试题，帮助自我检测学习效果。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_21-54-54.png)

  - 语音摘要生成：将音频文件转化为简洁摘要，节省时间。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-03-46.png)

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-21-29.png)

  - 影片摘要生成：将视频内容总结为简明扼要的摘要，方便快速理解。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-12-50.png)

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-33-08.png)

  - 思维导图延伸：通过思维导图形式，帮助拓展和关联知识点。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-16-03.png)

  - 生成各类报告：根据输入资料自动生成报告，支持不同格式。
  
    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-16-51.png)

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-26_22-20-03.png)

  - 录音会议纪要：通过应用自动生成会议纪要，节省时间。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/IMG_1147.PNG)

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/IMG_1148.PNG)

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/IMG_1149.PNG)
...
### 通义法睿（https://tongyi.aliyun.com/farui/chat）

* 专为法律领域设计，具备深度理解和推理能力，能够通过自然语言与用户互动，解答法律问题、推送裁判案例、辅助案情分析、生成法律文书、检索法律知识。通过精准理解用户问题，正确引用相关法规和案例提供解答，并能根据案情自动总结法律诉求并撰写法律文书。平台自带法律法规和裁判案例库，支持全面的法律检索。

* 适用人群：适用于公司财务和法务团队，可广泛用于法律咨询、法律事务处理及法律文书编写。

* 功能使用：

  - 法律咨询：点击“法律咨询”并输入问题，快速获取解答。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/%E5%9B%BE%E7%89%871.png)

  - 法律检索：点击“法律检索”，输入关键词，迅速获取相关法律信息。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/%E5%9B%BE%E7%89%872.png)

  - 合同检索：上传合同文件，系统自动进行合同审查与检索。

* 优点：

  - 法律条文解析精准，合同审查自动化，及时预警合规风险。

* 缺点：

  - 专注法律垂直领域，需使用专业术语，更新速度较慢。

* 缺点：

  - 需要较高的本地机器配置，且模型加载消耗资源。

### Nanobanana Pro（https://gemini.google.com/app 需翻墙）

* 基于 Gemini 3 Pro，Nanobanana Pro 是一款先进的图像生成模型，结合了强大的推理能力和丰富的世界知识，能够精确生成图像与清晰的文字，同时提供专业级的设计一致性与光影控制，助力将创意完美具象化。

* 适用人群：适用于公司所有同事，帮助生成各种创意图片，提升设计效果。
...
### Sora2（https://sora.chatgpt.com 需翻墙）

* OpenAI于2025年推出的最新AI影片生成模型，能够根据简单的文字提示（prompt）生成具有电影质感的短片，支持人物对话、背景音效和环境音等。

* 使用人群：适用于公司所有同事，可用于生成各类创意影片。

* 功能使用：

  - 上传角色线稿后，可以在视频中创建自定义角色。
  ...
  - 艾特自定义角色并创建视频：选择自定义角色，输入视频内容提示词，点击创建，快速生成影片。
...
### VEED（https://veed.io 需翻墙）

* 云端视频制作平台，提供一站式视频剪辑、字幕、配音工具。

* 适用人群：适用于公司所有同事，支持在线编辑和快速制作视频。

* 功能使用：

  - 上传视频并裁剪：上传视频后，选择视频编辑，进行裁剪操作。

    ![](https://raw.githubusercontent.com/Garden12138/picbed-cloud/main/ai/Snipaste_2025-11-23_23-11-29.png)

  - 自动生成字幕并编辑：选择自动字幕功能，生成字幕后可修改字幕文本和样式，最终保存编辑好的视频。
...
* 优点：
  ...
  - 界面简洁、操作便捷，拖拽即可完成编辑，适合新手快速上手。
  - 内置AI智能功能：自动字幕、降噪、语音合成等，提升视频编辑效率。

* 缺点：

  - 免费版带水印，AI功能及导出分辨率有限制。

### Suno（https://suno.com 需翻墙）

* 一款生成式AI音乐创作工具，结合人声与乐器生成逼真歌曲。

* 适用人群：适用于公司所有同事，帮助我们创造动听的音乐作品。

* 功能使用：

  - 普通创造：输入提示词，选择音乐风格，点击生成，快速创作歌曲。
...
* 优点：
  ...
  - 操作简便，几分钟内即可生成完整歌曲。
  - 支持多种风格、自动生成歌词及人声，适合快速试验。
  - 无需音乐基础，即使是普通人也能创作出“可听”的音乐。
...
* 该平台支持AI生成商业设计图和营销素材，通过智能优化视觉内容，提高商品营销效率。

* 适用人群：公司运营同事，快速生成广告营销图文及视频素材。

* 功能使用：

  - 商品图生成：输入商品链接并添加创意描述，启用智能营销文案后，点击生成商品图。
  ...
  - 商品营销视频生成：输入商品链接，自动生成卖点，并设置视频配置，点击生成营销视频。
...
### Google Stitch（https://stitch.withgoogle.com 需翻墙）

* Google 开发的 AI 设计工具，旨在简化 UI 设计流程，让没有设计背景的用户也能轻松创建高质量的设计。只需输入文字或上传图片/草图，Stitch 就能将创意转化为视觉设计，且支持导出 HTML/CSS 代码。

* 适用人群：公司需求分析师、UI设计师。

* 功能使用：

  - 生成WEB UI设计：输入文字描述，点击生成符合要求的网页UI设计。
...
* 缺点：
  ...
  - 目前为BETA版本，功能可能会随时更新或调整。

### Cherry Studio（https://www.cherry-ai.com）

* 一款强大的国产开源AI工具，支持本地部署、知识库管理、多模型聚合与联网搜索等功能。

* 适用人群：适用于公司所有同事，可以帮助我们构建AI小助手。
...
* 功能使用：
  ...
  - 选择智能体并添加助手：选择智能体，添加到助手中，输入对话内容后点击发送。
...
* 优点：
  ...
  - 功能丰富，提供良好的交互体验，部署和安装过程简便。

* 缺点：

  - 存在一定的系统BUG，使用时可能会遇到一些不稳定性问题。

### LobeChat（http://localhost:3210/chat）

* 开源多模型对话平台，支持本地与云端模型，提供可视化框架，便于构建自定义AI助手。

* 适用人群：适用于公司所有同事，特别适合打造智能客服和办公效率助手。

* 功能使用：

  - 设置模型 API KEY：配置模型API密钥，开始使用。
  ...
  - 自定义助手：创建自定义助手，选择模型，设置角色设定并输入对话。
...
### Dify（https://cloud.dify.ai/apps 需翻墙）

* 一款开源平台，用于构建AI工作流。通过可视化画布编排AI模型、连接数据源并定义处理流程，轻松将领域知识转化为可运行的应用。

* 适用人群：适用于公司所有同事，帮助我们快速搭建AI工作流应用。
...
* 提供统一的提示词管理和调试平台，帮助优化和调整提示词效果。

* 适用人群：适用于公司所有同事，特别是在工作流编排中使用调试和优化提示词。

* 功能使用：

  - 提示词生成：点击“Prompt生成”，输入需求描述并点击生成，快速获取提示词。
  ...
  - 提示词调试：点击“验证”或“Prompt调试”，使用“优化您的Prompt”功能，选择模型后点击生成模型回答，查看效果。
...
* 缺点：
  ...
  - 需要一定的学习成本，初学者可能需要时间适应。

### RunnigHub（https://www.runninghub.cn）

* 在线ComfyUI平台，旨在简化并加速AI图像和视频生成工作流程。

* 适用人群：适用于公司所有同事，支持手动编排图像或视频生成工作流。

* 功能使用：

  - 运行工作流：点击“工作流”，选择已发布的工作流，进入编辑页面，编辑完成后点击运行，生成结果可在右侧任务栏查看。
...
* 开源大型语言模型服务工具，支持在本地快速部署和运行多个开源大模型，简化了安装和启动过程。

* 适用人群：适用于公司所有同事，允许在本地运行开源大型语言模型。

* 功能使用：

  - 在官网搜索并复制所需模型的运行命令，轻松在本地启动模型。
