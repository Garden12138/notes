...
WWUD means "What Would User Do". Use it to make Bojin's AI decisions closer to the current user's real judgment, role logic, taste, and operating habits.
